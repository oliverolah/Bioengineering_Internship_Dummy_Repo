"""
Django settings for maindummy project.
...
SECRET_KEY = 'django-insecure-%v3qdi8bisb*pzs@7=-dogmd3rb5f&%rkln1)lp9%_u(8am(o-'
...
INSTALLED_APPS = [
    ...
    'dummyappone.apps.DummyapponeConfig'
...
WSGI_APPLICATION = 'maindummy.wsgi.application'
